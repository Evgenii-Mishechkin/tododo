<script lang="ts">
	...
	let pageUnsub: Unsubscriber;
	onMount(() => {
		pageUnsub = page.subscribe(($page) => {
	...
	// Функция определения активного маршрута
...
<header class="bg-white shadow-md">
	<div class="container mx-auto flex items-center flex-wrap justify-between px-6 py-4">
		<!-- Logo -->
			...
			{#if isMenuOpen}
				...
				>
					<div class="flex justify-end p-4">
						<button on:click={toggleMenu} class="text-gray-700 focus:outline-none" aria-label="Close menu">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-8 w-8"
                fill="none"
